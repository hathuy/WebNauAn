...
$doc->addScript($scripts_urla.'jquery.isotope.min.js');
$doc->addScript($scripts_urla.'noconflict.js');
...
<div id="elslide">
<div id="elasticslideshow" class="ei-slider" style="height:<?php echo $container_height; ?>">
